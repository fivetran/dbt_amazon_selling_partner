...
{% set columns = [
    ...
    {"name": "item_height_value", "datatype": dbt.type_float()},
    {"name": "item_length_unit", "datatype": dbt.type_string()},
    {"name": "item_length_value", "datatype": dbt.type_float()},
    {"name": "item_weight_unit", "datatype": dbt.type_string()},
    {"name": "item_weight_value", "datatype": dbt.type_float()},
    {"name": "item_width_unit", "datatype": dbt.type_string()},
    {"name": "item_width_value", "datatype": dbt.type_float()},
    {"name": "marketplace_id", "datatype": dbt.type_string()},
    {"name": "package_height_unit", "datatype": dbt.type_string()},
    {"name": "package_height_value", "datatype": dbt.type_float()},
    {"name": "package_length_unit", "datatype": dbt.type_string()},
    {"name": "package_length_value", "datatype": dbt.type_float()},
    {"name": "package_weight_unit", "datatype": dbt.type_string()},
    {"name": "package_weight_value", "datatype": dbt.type_float()},
    {"name": "package_width_unit", "datatype": dbt.type_string()},
    {"name": "package_width_value", "datatype": dbt.type_float()}
] %}
