...
{% set columns = [
    ...
    {"name": "item_approval_context_approval_status", "datatype": dbt.type_string()},
    {"name": "item_approval_context_approval_type", "datatype": dbt.type_string()},
    ...
    {"name": "points_granted_points_number", "datatype": dbt.type_int()},
    {"name": "price_designation", "datatype": dbt.type_string()},
