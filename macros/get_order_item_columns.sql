...
{% set columns = [
    ...
    {"name": "promotion_discount_amount", "datatype": dbt.type_float()},
    {"name": "promotion_discount_currency_code", "datatype": dbt.type_string()},
    {"name": "promotion_discount_tax_amount", "datatype": dbt.type_float()},
    ...
    {"name": "shipping_discount_amount", "datatype": dbt.type_float()},
    {"name": "shipping_discount_currency_code", "datatype": dbt.type_string()},
    {"name": "shipping_discount_tax_amount", "datatype": dbt.type_float()},
