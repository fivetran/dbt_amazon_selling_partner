...
{% set columns = [
    ...
    {"name": "buyer_info_buyer_county", "datatype": dbt.type_string()},
    ...
    {"name": "buyer_invoice_preference", "datatype": dbt.type_string()},
    {"name": "buyer_tax_info_buyer_business_address", "datatype": dbt.type_string()},
    {"name": "buyer_tax_info_buyer_legal_company_name", "datatype": dbt.type_string()},
    {"name": "buyer_tax_info_buyer_tax_office", "datatype": dbt.type_string()},
    {"name": "buyer_tax_info_buyer_tax_registration_id", "datatype": dbt.type_string()},
    {"name": "cba_displayable_shipping_label", "datatype": dbt.type_string()},
    ...
    {"name": "latest_delivery_date", "datatype": "datetime"},
    {"name": "latest_ship_date", "datatype": "datetime"},
    ...
    {"name": "promise_response_due_date", "datatype": "datetime"},
    {"name": "purchase_date", "datatype": "datetime"},
    {"name": "replaced_order_id", "datatype": dbt.type_string()},
    {"name": "sales_channel", "datatype": dbt.type_string()},
    {"name": "seller_display_name", "datatype": dbt.type_string()},
